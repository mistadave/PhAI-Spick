...
$
  ...
  r_2 & =600m-(15 m/s dot 20 s)-(1/2 dot -0.75 m/s^2 dot (20 s)^2 ) \
      & =450m
$
...
$
  12 & = v_0 dot cos(-20^circle.small) dot t <=> v_0 dot t = 12 / cos(-20^circle.small) \
     & = 12.77
$
...
$
  F_S & = m_a dot a+μ dot m_a dot g            \
      & = 1 dot 3.92+0.5 dot 1 dot 9.81=8.67 N
$
...
$F_(G,b) = m_b*arrow(g), arrow(F)_(Z,b) = F_z vec(0, -1)$
Newtonsches Gesetz: $m_b arrow(a)_b = arrow(F)_(G,b) + arrow(F)_(Z,b)$
Res skalare Beschleunigung: $a_b = frac(m_b g, m_b) - frac(F_z, m_b) = g-frac(F_z, m_b)$

Da Seil gespannt, müssen $a_a$ und $a_b$ gleich sein: $a_a = a_b$ das ganze nach a umstellen und ausrechnen. Resultat: $a_a = 0.981m/s, "beschleunigung nach rechts oben"$
...
$
  Delta x & = x_2 - x_1 = x_R + l_0                                            \
          & = A cos(sqrt(k/m_1 +k/m_2) t) + B sin(sqrt(k/m_1 + k/m_2) t) + l_0
$
...
$
  E_0 & =1/2 dot m dot colgreen(0)^2+m dot g dot colmagenta(0)+(m dot g dot colorange(0) dot cos(alpha) ) dot μ \
      & = 0
$
